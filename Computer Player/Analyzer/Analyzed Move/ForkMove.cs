...
{
    public class ForkMove : OffensiveMove
    {
        public ForkMove(IMove move) : base(move)
        {
        }

        protected override bool Validate(IMove move)
        {
            var areThereAnyAtLeast2PlayersLineSegmentsWithLengthAsTheWinningConditionMinusTwo = (IMove move) =>
            {
            ...
            return base.Validate(move)
                && areThereAnyAtLeast2PlayersLineSegmentsWithLengthAsTheWinningConditionMinusTwo(move);
        }
    }
    }
